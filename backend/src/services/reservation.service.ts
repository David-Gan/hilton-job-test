...
export class ReservationService {
  ...
  public async create(data: Pick<Reservation, 'name' | 'contact' | 'size' | 'arrivalAt' | 'guest'>): Promise<ReservationModel> {
  ...
  public async update(id: string, data: Partial<Pick<Reservation, 'name' | 'contact' | 'size' | 'arrivalAt'>>): Promise<Reservation> {
